                    ...
                    <div className='flex items-center  px-4'>
                        ...
                        <nav  id="nav-menu" className ={`
                            ...
                            <ul className="block lg:flex ">
                                <li className="group">
                                    <NavLink to="/home" className={({ isActive }) => `text-xl font-semibold py-2 mx-10 flex transition-colors ${ isActive ? 'text-sky-500 font-bold border-sky-500 text-xl' : 'text-black hover:text-sky-400' }`}>Learn</NavLink>
                                </li>
                                <li className="group">
                                    <NavLink to="/leaderboard" className={({ isActive }) => `text-xl font-semibold py-2 mx-10 flex transition-colors ${ isActive ? 'text-sky-500 font-bold  border-sky-500 ' : 'text-black hover:text-sky-400' }`}>Leaderboard</NavLink>
                                </li>
                                <li className="group">
                                    <NavLink to="/history" className={({ isActive }) => `text-xl font-semibold py-2 mx-10 flex transition-colors ${ isActive ? 'text-sky-500 font-bold  border-sky-500 ' : 'text-black hover:text-sky-400' }`}>History</NavLink>
                                </li>
